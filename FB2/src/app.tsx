...
function Question(props:any) {
    ...
    return <div>
        ...
        {state.learnMode===true && <div style={{paddingLeft:'15px', paddingTop:'15px'}}>
                {state.currentQuestion >=0 && <button style={{marginRight:'15px'}} onClick={e=>onAdvance(-1)}>Zurück</button>}
                {state.currentQuestion < catalog.fragen.length-1 && <button  onClick={e=>onAdvance(1)}>Weiter</button> }
